...
mod LizInventory {
    ...
    struct Storage {
        ...
        productMap: LegacyMap<felt252,u32>
    }
    ...
    impl LizInventoryImpl of super::ILizInventory<ContractState> {
        fn add_stock(ref self: ContractState, product: felt252, new_stock: u32) {
            ...
            self.productMap.write(product,self.productMap.read(product)+new_stock);
        ...
        fn purchase(ref self: ContractState, product: felt252, quantity: u32) {
            ...
            self.productMap.write(product,self.productMap.read(product)-quantity);
        }
